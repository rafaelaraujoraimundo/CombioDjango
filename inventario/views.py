...
from .models import (AccountInfo, AcoesProntuario, BIOS, Celular, Computador, ControleFones,
    ...
    ProntuarioMonitor, Software, Status, Storage, TipoItem, UsuarioDesligamento)
from .forms import (AcoesProntuarioForm, CelularForm, ComputadorForm, ControleFonesForm,
    ...
    ProntuarioMonitorForm, StatusForm, TipoItemForm, UsuarioDesligamentoForm)
...
class UsuarioDesligamentoCreate(CreateView):
    ...
    template_name = 'inventario/desligamento/desligamento_form.html'
